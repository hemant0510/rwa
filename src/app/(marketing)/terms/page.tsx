...
export const metadata = {
  ...
  description: "Terms governing your use of the RWA Connect platform.",
};
    ...
    <article className="mx-auto max-w-3xl px-6 py-16">
      ...
      <div className="prose prose-sm max-w-none space-y-8 text-sm leading-relaxed">
        <section>
          ...
          <p>
            By registering or logging into RWA Connect (&ldquo;the platform&rdquo;), you agree to be
            bound by these Terms of Service. If you do not agree, do not use the platform. These
            terms apply to all users including residents, RWA admins, and super admins.
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            ...
            and community administration. The platform is operated by and for the Residents Welfare
            Association of each registered society.
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            ...
            . This includes your name, contact details, unit information, identity proof documents,
            and fee payment history.
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            ...
            resident data entered into the platform belongs to the respective society&apos;s RWA and
            its residents. No license to reproduce or distribute platform software is granted.
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            ...
            posted constitutes acceptance of the new terms. Significant changes will be communicated
            via the platform&apos;s announcement feature.
          </p>
        </section>
      </div>
