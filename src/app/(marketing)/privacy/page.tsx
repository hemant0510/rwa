...
export const metadata = {
  ...
  description:
    "How RWA Connect collects, uses, and protects your personal information under the DPDP Act 2023.",
};
  ...
  return (
    <article className="mx-auto max-w-3xl px-6 py-16">
      ...
      <div className="prose prose-sm max-w-none space-y-8 text-sm leading-relaxed">
        <section>
          ...
          <p>
            ...
            operated by Navara Tech. This Privacy Policy explains how we collect, use, store, and
            protect personal information submitted through this platform, in accordance with the
            Digital Personal Data Protection Act, 2023 (DPDP Act) and applicable Indian law.
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            Your data is stored in a PostgreSQL database hosted on Supabase (Singapore region) with
            encryption at rest. Access is protected by row-level security policies ensuring each
            society can only access its own residents&apos; data. We do not sell or share your
        ...
        <section>
          ...
          <p className="mt-2">
            To exercise any of these rights, contact the RWA Admin at your registered email address.
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            We use strictly necessary session cookies to maintain your authenticated session. We do
        ...
        <section>
          ...
          <p>
            ...
            updated &ldquo;Last updated&rdquo; date. Continued use of the platform after any changes
        ...
        <section>
          ...
          <p>
            For privacy-related queries, contact your RWA Admin through your registered email
            address, or write to Navara Tech at privacy@navaratech.in. For disputes, the governing
            law is the laws of India and jurisdiction is Bengaluru, Karnataka.
          </p>
        </section>
      </div>
      ...
      <div className="text-muted-foreground mt-12 border-t pt-6 text-center text-xs">
        ...
        ·{" "}
        <Link href="/refund-policy" className="hover:text-foreground underline">
          Refund Policy
        </Link>
      </div>
    </article>
